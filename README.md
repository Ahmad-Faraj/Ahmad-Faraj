...
#### $ About me  
CS student at [`Suez Canal University`](https://suez.edu.eg/ar/) — 1× `ECPC` Finalist, `Expert` @Codeforces. Interested in back-end, DevOps, low-level programming, and core CS like databases, compilers, and OS. I enjoy mathematics and open source contribution — and yes, I use `nvim`, btw.
<hr>
